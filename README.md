...
> **Alpha (`v0.1.0a13`).** The detect → fit → match → edit loop works end-to-end; expect
...
pip install "mlgidlab[pipeline] @ git+https://github.com/mlgid-project/mlgidLAB@v0.1.0a13"
mlgidlab
```
