...
> **Alpha (`v0.1.0a11`).** The detect → fit → match → edit loop works end-to-end; expect
...
<video src="https://github.com/user-attachments/assets/1f522b15-c076-4421-89e5-963a3f6e9429" controls muted width="100%"></video>
