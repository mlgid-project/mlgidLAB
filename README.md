...
> **Alpha (`v0.1.0a15`).** The detect → fit → match → edit loop works end-to-end; expect
...
pip install "mlgidlab[pipeline] @ git+https://github.com/mlgid-project/mlgidLAB@v0.1.0a15"
mlgidlab
```
